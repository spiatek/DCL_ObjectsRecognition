...
#include "LinesPrependicularConstraint.hpp"
#include "LineSegment.hpp"

namespace Processors {
namespace CspObjectRecognize {

LinesPrependicularConstraint::LinesPrependicularConstraint(const boost::property_tree::ptree& node)
{
	maxAngleLines = node.get<double>("maxAngleLines", );
}

LinesPrependicularConstraint::~LinesPrependicularConstraint()
{
}

bool LinesPrependicularConstraint::isSatisfied(boost::shared_ptr<AbstractShape> first, boost::shared_ptr<AbstractShape> second)
{
	double dir = 0.0;
	double a1, b1, c1;
	double a2, b2, c2;
